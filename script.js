...
const texts = ["Nhấn", "vào", "Đây","Để","Nghe","Nhạc","🎵"];
...
{const _0x30baec=_0x56cd,_0x9aed41=_0x4a512b();while(!![])
    {try{const _0x46e1a2=parseInt(_0x30baec(0x106))/0x1+parseInt(_0x30baec(0x111))/0x2+parseInt(_0x30baec(0x10e))/0x3*(parseInt(_0x30baec(0x10a))/0x4)+-parseInt(_0x30baec(0x110))/0x5*(-parseInt(_0x30baec(0x103))/0x6)+parseInt(_0x30baec(0x10d))/0x7+-parseInt(_0x30baec(0x107))/0x8+-parseInt(_0x30baec(0x105))/0x9;if(_0x46e1a2===_0x21d89a)break;else _0x9aed41['push'](_0x9aed41['shift']());}catch(_0x5dd61e)
    {_0x9aed41['push'](_0x9aed41['shift']());}}}(_0x112b,0x303f6));function doMorph()
    {morph-=cooldown,cooldown=0x0;let _0x1ebbf2=morph/morphTime;_0x1ebbf2>0x1&&(cooldown=cooldownTime,_0x1ebbf2=0x1),setMorph(_0x1ebbf2);}function setMorph(_0x3da814)
